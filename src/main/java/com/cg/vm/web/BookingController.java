...
public class BookingController {
	...
	@GetMapping("/{id}")
	public ResponseEntity<?> getByBookingId(@PathVariable int id) {
	...
	public ResponseEntity<List<Booking>> viewAllByBookingDate(@PathVariable LocalDate bookingDate) throws ParseException

	{
		List<Booking> bookingByDate = bookingService
				.viewBookingByBookingDate(bookingDate);
		return new ResponseEntity<List<Booking>>(bookingByDate, HttpStatus.OK);
	}
	...
	public ResponseEntity<String> cancelBookingById(int bookingId)
	{
		...
		return new ResponseEntity<String>("Booking Id" + " "+ bookingId + " "+"cancelled successfully", HttpStatus.OK);
	}
